...
company_list_str = ['AAPL', 'GOOG', 'MSFT', 'AMZN']
...
# closing_df = DataReader('AAPL', 'yahoo', start, end)['Adj Close']
closing_df = yf.download(company_list_str, '2022-02-21', '2023-02-21')['Adj Close']
...
# Get the stock quote
df = yf.download('AAPL', '2012-01-01', datetime.now())
